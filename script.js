...
function saveProject() {
  ...
  // Save project data as JSON string
  localStorage.setItem('DIGICAL_PROJECT_' + projectName, JSON.stringify(data));

  alert(`Project '${projectName}' saved!`);

  // Refresh saved projects dropdown
  loadSavedProjects();

  // Set the project dropdown to current project
  document.getElementById('savedProjects').value = projectName;
}
...
document.getElementById('savedProjects').addEventListener('change', (e) => loadProject(e.target.value));
